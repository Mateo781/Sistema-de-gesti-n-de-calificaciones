...
// Si ya está logueado, enviar al panel
if (isset($_SESSION['usuario_id'])) {
    header('Location: index.php');
    exit;
}

// Obtener mensajes de error o estado de sesión
...
// Limpiar variables de sesión tras usarlas
...
<link rel="stylesheet" href="../css/suplente/login.css">
</head>
<body>
  ...
  <aside class="auth-brand">
    ...
    <div class="brand-features">
      ...
      <div class="feat-item">
        ...
        <span class="feat-text">Roles diferenciados: administrador, docente, alumno y tutor</span>
      </div>
      <div class="feat-item">
        <div class="feat-ico">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
          ...
          <div class="field-group">
            ...
            <div class="field">
              ...
              <select class="field-select" id="reg_rol" name="id_rol" required>
                ...
                <option value="5">Preceptor</option>
